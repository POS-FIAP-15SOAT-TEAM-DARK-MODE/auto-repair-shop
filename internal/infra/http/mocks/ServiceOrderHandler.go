...
func (_m *ServiceOrderHandler) GetStatus(_a0 *gin.Context) {
	_m.Called(_a0)
}

// ServiceOrderHandler_GetStatus_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetStatus'
type ServiceOrderHandler_GetStatus_Call struct {
	*mock.Call
}

// GetStatus is a helper method to define mock.On call
//   - _a0 *gin.Context
func (_e *ServiceOrderHandler_Expecter) GetStatus(_a0 interface{}) *ServiceOrderHandler_GetStatus_Call {
	return &ServiceOrderHandler_GetStatus_Call{Call: _e.mock.On("GetStatus", _a0)}
}

func (_c *ServiceOrderHandler_GetStatus_Call) Run(run func(_a0 *gin.Context)) *ServiceOrderHandler_GetStatus_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*gin.Context))
	})
	return _c
...
func (_c *ServiceOrderHandler_GetStatus_Call) Return() *ServiceOrderHandler_GetStatus_Call {
	_c.Call.Return()
	return _c
}

func (_c *ServiceOrderHandler_GetStatus_Call) RunAndReturn(run func(*gin.Context)) *ServiceOrderHandler_GetStatus_Call {
	_c.Run(run)
	return _c
}
