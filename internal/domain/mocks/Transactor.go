...
func (_m *Transactor) WithTransaction(ctx context.Context, fn domain.TxFunc) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, domain.TxFunc) error); ok {
		r0 = rf(ctx, fn)
	} else {
		r0 = ret.Error(0)
	}
...
//   - ctx context.Context
//   - fn domain.TxFunc
func (_e *Transactor_Expecter) WithTransaction(ctx interface{}, fn interface{}) *Transactor_WithTransaction_Call {
	return &Transactor_WithTransaction_Call{Call: _e.mock.On("WithTransaction", ctx, fn)}
}

func (_c *Transactor_WithTransaction_Call) Run(run func(ctx context.Context, fn domain.TxFunc)) *Transactor_WithTransaction_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(domain.TxFunc))
	})
	return _c
}
...
func (_c *Transactor_WithTransaction_Call) RunAndReturn(run func(context.Context, domain.TxFunc) error) *Transactor_WithTransaction_Call {
	_c.Call.Return(run)
	return _c
}
