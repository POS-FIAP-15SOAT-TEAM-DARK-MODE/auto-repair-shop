...
func (_m *ServiceOrderRepository) ListSuppliesByServiceOrderID(ctx context.Context, serviceOrderID string) ([]supplydomain.Supply, error) {
...
func (_c *ServiceOrderRepository_ListSuppliesByServiceOrderID_Call) Return(_a0 []supplydomain.Supply, _a1 error) *ServiceOrderRepository_ListSuppliesByServiceOrderID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ServiceOrderRepository_ListSuppliesByServiceOrderID_Call) RunAndReturn(run func(context.Context, string) ([]supplydomain.Supply, error)) *ServiceOrderRepository_ListSuppliesByServiceOrderID_Call {
	_c.Call.Return(run)
	return _c
}
